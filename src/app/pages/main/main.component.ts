...
import {XlsxService} from "../../shared/xlsx/xlsx.service";
...
export class MainComponent implements OnInit{
  ...
  onClickExportExcelCounterTable(): void {
    this.xlsxService.exportExcelCounterTable(this.selectedCounter.selectedCounter, this.selectedCounter.previousCounter);
  }
